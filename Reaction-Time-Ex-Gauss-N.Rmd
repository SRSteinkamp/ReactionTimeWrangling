...
## You can find the interactive notebook [here](https://github.com/SRSteinkamp/ReactionTimeWrangling/Reaction-Time-Ex-Gauss-I.html), **caution** it's about 7MB in size, so not your average website!
...
There is unfortunately, too much data to have good look at, so here is a `datatable` (in the interactive version - the simulations can also been found in the Github Repro) to play around with and investigate some of the summary values.
